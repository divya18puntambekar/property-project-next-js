  ...
  return (
    <main>
      <div className="bg-white shadow-md rounded-lg p-6 border text-center md:text-left">
        ...
        <h3 className="bg-black text-white text-xl font-bold py-2 px-4 rounded ">
          Rates & Options
        </h3>
        <div className="flex justify-around mt-4">
          ...
          <div className="inline-flex items-center font-bold">
            Weekly
            <div className=" font-bold ml-2  text-blue-900 font-2xl">
              ${property.weekly_rates}
            </div>
          </div>
          <div className="inline-flex items-center font-bold">
            Monthly
